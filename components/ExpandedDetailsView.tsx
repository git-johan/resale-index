          ...
          <div className="flex items-center gap-10pt">
            ...
            <div className="h-6 flex items-center">
              <svg width="14" height="24" viewBox="0 0 14 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <foreignObject x="-2.59712" y="1.68901" width="17.8105" height="24.9091"><div style={{backdropFilter:'blur(1.3px)', clipPath:'url(#bgblur_0_71_430_clip_path)', height:'100%', width:'100%'}}></div></foreignObject>
